...
const StudentProfile = ({ student, onBack, onUpdateStudent }) => {
  ...
  return (
    <div className="container my-5">
      <div className="student-profile bg-light p-4 rounded shadow"> {/* Added shadow for better visibility */}
        ...
        {isEditing ? (
          ...
          <>
            ...
            <div className="submission-log-grading d-flex justify-content-between mt-3">
